class N_tagon
{
    ...
    this.size = 5.0;
    this.numSide = 5;
    this.array = generatePentagonVertices(this.position[0],this.position[1],this.numSide,this.size);
...
class N_tagon
{
    ...
    render(){
        ...
        drawPentagon(this.position[0],this.position[1],this.numSide,this.size);
    }
}
...
function drawPentagon(x,y,n,size)
{
    //let array = generatePentagonVertices(0,0,5,0.2);
    //let array = the270DegreeRotationArray(generatePentagonVertices(x,y,n,size));
    let array = generatePentagonVertices(x,y,n,size);
