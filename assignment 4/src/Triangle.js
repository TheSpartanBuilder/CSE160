...
function drawTriangle3DNormal(vertices,normal)
{
    var n = 3; // The number of vertices
...
function drawTriangle3DBatchUVNormal(vertices,uv,normal)
{
    var n = (vertices.length)/3; // The number of vertices
...
function drawTriangle3DBatchColorNormalUV(vertices,color,normal,uv)
{
    var n = (vertices.length)/3; // The number of vertices
    ...
    // Create a buffer object for color
    var colorBuffer = gl.createBuffer();
    if(!colorBuffer) {
        console.log('Failed to create the buffer object');
        return -1;
...
function drawTriangle3DBatchColorNormal(vertices,color,normal)
{
    var n = (vertices.length)/3; // The number of vertices
