class TomNormal {
    constructor() {
        ...
        // Setting objects
        this.body = new CubeNormal();
        this.outerBody = new CubeNormal();
        this.leftLegUp = new CubeNormal();
        this.leftLegDown = new CubeNormal();
        this.leftFeet = new CubeNormal();
        this.rightLegUp = new CubeNormal();
        this.rightLegDown = new CubeNormal();
        this.rightFeet = new CubeNormal();
        this.leftArmUp = new CubeNormal();
        this.leftArmDown = new CubeNormal();
        this.leftHand = new CubeNormal();
        this.rightArmUp = new CubeNormal();
        this.rightArmDown = new CubeNormal();
        this.rightHand = new CubeNormal();
        ...
        this.head = new CubeNormal();
        this.mouth = new CubeNormal();
        this.nose = new CubeNormal();
        this.leftEye = new CubeNormal();
        this.leftPupilOutside = new CubeNormal();
        this.leftPupil = new CubeNormal();
        this.rightEye = new CubeNormal();
        this.rightPupilOutside = new CubeNormal();
        this.rightPupil = new CubeNormal();
        this.firstLeftWhisker = new CubeNormal();
        this.secondLeftWhisker = new CubeNormal();
        this.thirdLeftWhisker = new CubeNormal();
        this.firstRightWhisker = new CubeNormal();
        this.secondRighWhisker = new CubeNormal();
        this.thirdRightWhisker = new CubeNormal();
    ...
    setLocationMatrix(matrix)
    {
        this.locationMatrix.set(matrix);
    }

    resetObjectIdentityMatrix()
    {
    ...
    resetObjectMatrix()
    {
        this.body.matrix.set(this.locationMatrix);
        this.outerBody.matrix.set(this.locationMatrix);
        this.leftLegUp.matrix.set(this.locationMatrix);
        this.leftLegDown.matrix.set(this.locationMatrix);
        this.leftFeet.matrix.set(this.locationMatrix);
        this.rightLegUp.matrix.set(this.locationMatrix);
        this.rightLegDown.matrix.set(this.locationMatrix);
        this.rightFeet.matrix.set(this.locationMatrix);
        this.leftArmUp.matrix.set(this.locationMatrix);
        this.leftArmDown.matrix.set(this.locationMatrix);
        this.leftHand.matrix.set(this.locationMatrix);
        this.rightArmUp.matrix.set(this.locationMatrix);
        this.rightArmDown.matrix.set(this.locationMatrix);
        this.rightHand.matrix.set(this.locationMatrix);
        this.firstTail.matrix.set(this.locationMatrix);
        this.secondTail.matrix.set(this.locationMatrix);
        this.thirdTail.matrix.set(this.locationMatrix);
        this.forthTail.matrix.set(this.locationMatrix);
        this.fithTail.matrix.set(this.locationMatrix);
        this.sixthTail.matrix.set(this.locationMatrix);
        this.head.matrix.set(this.locationMatrix);
        this.mouth.matrix.set(this.locationMatrix);
        this.nose.matrix.set(this.locationMatrix);
        this.leftEye.matrix.set(this.locationMatrix);
        this.leftPupilOutside.matrix.set(this.locationMatrix);
        this.leftPupil.matrix.set(this.locationMatrix);
        this.rightEye.matrix.set(this.locationMatrix);
        this.rightPupilOutside.matrix.set(this.locationMatrix);
        this.rightPupil.matrix.set(this.locationMatrix);
        this.firstLeftWhisker.matrix.set(this.locationMatrix);
        this.secondLeftWhisker.matrix.set(this.locationMatrix);
        this.thirdLeftWhisker.matrix.set(this.locationMatrix);
        this.firstRightWhisker.matrix.set(this.locationMatrix);
        this.secondRighWhisker.matrix.set(this.locationMatrix);
        this.thirdRightWhisker.matrix.set(this.locationMatrix);
        this.leftEar.matrix.set(this.locationMatrix);
        this.leftInnerEar.matrix.set(this.locationMatrix);
        this.rightEar.matrix.set(this.locationMatrix);
        this.rightInnerEar.matrix.set(this.locationMatrix);
    }
    ...
    render() {
        ...
        this.leftLegUp.matrix.translate(-0.14,-0.2,0.07);
        ...
        this.rightLegUp.matrix.translate(0.02,-0.2,0.07);
        ...
        this.leftArmUp.matrix.translate(-0.265,0.2,0.07);
        ...
        this.rightArmUp.matrix.translate(0.15,0.2,0.07);
        ...
        this.firstTail.matrix.translate(0,-0.15,0.23);
    ...
    renderFast() {
        ...
        this.body.matrix.translate(-.50,-.45,0);
        let bodyMatrix = new Matrix4(this.body.matrix);
        this.body.renderFaster();

        this.outerBody.color = this.lightGray.slice();
        this.outerBody.matrix.set(bodyMatrix);
        this.outerBody.matrix.scale(1.2,1.2,1.2);
        this.outerBody.matrix.translate(-0.08,-0.08,0.1);
        this.outerBody.renderFaster();
        ...
        let rightDownMatrix = new Matrix4(this.rightLegDown.matrix);
        matrixScaleMass(this.rightLegDown.matrix,this.legDownDimention);
        this.rightLegDown.renderFaster();
        ...
        let rightArmDownMatrix = new Matrix4(this.rightArmDown.matrix);
        matrixScaleMass(this.rightArmDown.matrix,this.armUpDimention);
        this.rightArmDown.renderFaster();
        ...
        this.leftPupilOutside.matrix.translate(0.09,0.13,-0.03);
        matrixScaleMass(this.leftPupilOutside.matrix,this.pupilOutsideSize);
        this.leftPupilOutside.renderFaster();
        ...
        this.rightPupilOutside.matrix.translate(0.195,0.13,-0.03);
        matrixScaleMass(this.rightPupilOutside.matrix,this.pupilOutsideSize);
        this.rightPupilOutside.renderFaster();
        ...
        this.firstLeftWhisker.matrix.rotate(70,0,0,1);
        matrixScaleMass(this.firstLeftWhisker.matrix,this.whiskerSize);
        this.firstLeftWhisker.renderFaster();
        ...
        this.secondLeftWhisker.matrix.rotate(90,0,0,1);
        matrixScaleMass(this.secondLeftWhisker.matrix,this.whiskerSize);
        this.secondLeftWhisker.renderFaster();
        ...
        this.thirdLeftWhisker.matrix.rotate(110,0,0,1);
        matrixScaleMass(this.thirdLeftWhisker.matrix,this.whiskerSize);
        this.thirdLeftWhisker.renderFaster();
        ...
        this.firstRightWhisker.matrix.rotate(250,0,0,1);
        matrixScaleMass(this.firstRightWhisker.matrix,this.whiskerSize);
        this.firstRightWhisker.renderFaster();
        ...
        this.secondRighWhisker.matrix.rotate(270,0,0,1);
        matrixScaleMass(this.secondRighWhisker.matrix,this.whiskerSize);
        this.secondRighWhisker.renderFaster();
        ...
        this.thirdRightWhisker.matrix.rotate(290,0,0,1);
        matrixScaleMass(this.thirdRightWhisker.matrix,this.whiskerSize);
        this.thirdRightWhisker.renderFaster();
